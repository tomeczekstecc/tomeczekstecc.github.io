...
WHERE wnp.numer_wniosku='WNP-RPSL.11.01.04-24-01HF/18-006-01'
ORDER BY 1 ASC";
    ...
    <nav class="container-fluid bg-dark p-2">
        <div class="row nav-wrap">
            <div id="nav-header text-center" class="col-md-8 col-sm-12">
                <h2 class="text-center">FAKTUROMAT</h2>
            </div>
        ...
        <div class="hero p-3 m-2 bg-primary">
            <div class="hero-heading text-center">
                ...
                <h3>Aplikacja słuzy do losowania wybranej liczby dokumentów potwierdzających poniesione wydatki, które zostały
                    dołączone do wniosku o płatnośc złożonego w ramach RPO WSL 2014-2020. Losując dokumenty wybierz ich liczbę
                    oraz minimalny lub maksymalny procent, rozumiany jako procent w ogólnej liczbie dokumenów</h3>
            </div>
            <div class="desc"></div>
        </div>
